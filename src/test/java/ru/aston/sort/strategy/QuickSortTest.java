...
public class QuickSortTest {
    private static List<Car> createCars() {
        ...
        cars.add(createCar(150, "Audi", 2016));
    ...
    void testSortCarsByPower() {
        ...
        assertEquals(150, cars.get(3).getPower());
        assertEquals(200, cars.get(4).getPower());
        assertEquals(300, cars.get(5).getPower());
        assertEquals(300, cars.get(6).getPower());
    }
    ...
    void testSortCarsByModel() {
        ...
        assertEquals("Opel", cars.get(4).getModel());
        assertEquals("Toyota", cars.get(5).getModel());
    ...
    void testSortCarsByProductionYear() {
        ...
        assertEquals(1992, cars.get(2).getProductionYear());
        assertEquals(2003, cars.get(3).getProductionYear());
        assertEquals(2008, cars.get(4).getProductionYear());
        assertEquals(2015, cars.get(5).getProductionYear());
        assertEquals(2016, cars.get(6).getProductionYear());
    }
